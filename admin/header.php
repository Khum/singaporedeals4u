...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Singaporedeals4u Admin Panel<?php echo (!empty($page_title) ? " - " . $page_title : ""); ?></title>
...
//        });
	...
	$("#rightValues2").change(function () {
       ...
       // ================== For other Services in add product page=========
        $(document).ready(function() {
                    ...
                    <div class="span2 main-menu-span">
                        <div class="well nav-collapse sidebar-nav">
                            <ul class="nav nav-tabs nav-stacked main-menu">
                                ...
                                <li><a class="ajax-link" href="category.php"><i class="icon-edit"></i><span class="hidden-tablet"> Category</span></a></li>
                                <li><a class="ajax-link" href="product_listing.php"><i class="icon-align-justify"></i><span class="hidden-tablet"> Product Listing</span></a></li>
                                <li><a class="ajax-link" href="product.php"><i class="icon-picture"></i><span class="hidden-tablet"> Add/Edit Product</span></a></li>
                                <li><a class="ajax-link" href="order.php"><i class="icon-align-justify"></i><span class="hidden-tablet"> Order</span></a></li>
                                <li><a class="ajax-link" href="inquiry.php"><i class="icon-info-sign"></i><span class="hidden-tablet"> Inquiry</span></a></li>
                                 <li><a class="ajax-link" href="services.php"><i class="icon-align-justify"></i><span class="hidden-tablet"> Other Services</span></a></li>
