...
function customPaging($sql, $ListRecPerPage = 20, $rewrite_url=false) {
    ...
    $nav_links = $pg->navigation(" ", "current", false, $rewrite_url); // the navigation links (define a CSS class selector for the current link)
...
function getRows($from, $where = '', $select = '*', $sort_order = '', $join = '', $group_by = '', $do_paging = "N", $record_per_page = '20', $rewrite_url = false) {
    $order_by = "";
    $sqlWhere = "";
    $joinSql = "";
    if (is_array($select)) {
...
function searchRows($from, $where = '', $select = '*', $sort_order = '', $join = '', $group_by = '', $do_paging = "N", $record_per_page = '20', $rewrite_url = false) {
    $order_by = "";
    $sqlWhere = "";
    $joinSql = "";
    if (is_array($select)) {
