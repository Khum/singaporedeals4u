...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Lato:300,400' rel='stylesheet' type='text/css'>
        <style>
        	.checkout_btn{
        		background: #e04f67 none repeat scroll 0 0 !important;
            		color: #fff;
...
<section id="hero_2" style="height:200px !important; display:none">
    ...
    <div class="row">
    <div class="col-md-8" id="cart_item_display">
            ...
            <tr>
              ...
              <!---   <td>
                   <div class="numbers-row">
                        <input type="text" value="<?php //echo $item['pkg']; ?>" id="quantity_<?php //$item['pid']; ?>" class="qty2 form-control" name="quantity_1">
                    </div> 
...
<!--            <tr>
        ...
        ?>
        <a class="btn_full checkout_btn" href="payment.php">Check out</a>
