...
header("Location:http://www.singaporedeals4u.com/categorywise_tours_list.php?id=19");
?>
<!DOCTYPE html>
...
<section id="hero_2">
    ...
    <div class="col-md-8">
    	<table class="table table-striped cart-list add_bottom_30">
            ...
            <tr>
                ...
                <td>
                    <div class="numbers-row">
                        <input type="text" value="<?php echo $item['a_qty']; ?>" id="aqty_<?php echo $item['pid']; ?>" class="qty2 form-control" name="quantity_1">
                    </div>
                    
                </td>
                <td>
                    <div class="numbers-row">
                        <input type="text" value="<?php echo $item['c_qty']; ?>" id="cqty_<?php echo $item['pid']; ?>" class="qty2 form-control" name="quantity_1">
                    </div>
        ...
        <?php
            ...
            $services = "select * from services order by id asc";
            ...
            while( $assoc = mysql_fetch_assoc($sql_ser) )        
            {
              ...
              switch($option)
              {
                  ...
                  case 25:
                      ...
                      break;
                  case 26:
                      $name = $_SESSION[$uname][$prod_id]['cofee']['name'];
                      $term = 'cofee';
                      break;
                  case 27:
    ...
    <div class="box_style_1">
        ...
        ?>
            <tr>
                <td>
                    Adults( SGD <?php echo $item['adult_price']; ?> )
                </td>
            ...
            <tr>
                <td>
                    Childs( SGD <?php echo $item['child_price']; ?>)
                </td>
        ...
        <?php 
            ...
            $others = $_SESSION[$_SESSION['Auth_name']][$prod_id]['guide']['price'] + $_SESSION[$_SESSION['Auth_name']][$prod_id]['pickup']['price'] 
                    ...
                    +$_SESSION[$_SESSION['Auth_name']][$prod_id]['welcome']['price'] + $_SESSION[$_SESSION['Auth_name']][$prod_id]['dinner']['price']
                        + $_SESSION[$_SESSION['Auth_name']][$prod_id]['bike']['price']; 
...
function services(id)
{
    ...
    var sid = $('#'+id).val();
        ...
        $.ajax({
            ...
            data: {action:action,  sid:sid, pid:pid,total_final:total_final },
            beforeSend: function( msg ) {
              $("#progress").show(); 
            }
          })
