...
<!--        <div class="layer"></div>-->
        ...
        <!-- Header================================================== -->
        <header id="plain" ondragstart="return false;" ondrop="return false;"><?php include_once 'header.php'; ?></header><!-- End Header -->
...
<!--        <div class="tp-banner-container">
        ...
        <!-- End Slider -->
        <br><br><br><br>
        <div class="col-md-12 margin_60" style="float:none">
            ...
            <div class="main_title">
                ...
                $rows_data = getorderRows(DB_TABLE_PREFIX . 'product', $where, '*', $sort_order, '', '', 'Y', '16');
                ...
                <div class="row">
                    ...
                    foreach ($product_data as $product) {
                        ...
                        if ($title == "Universal Studio Singapore&amp;trade;" || $title == "S.E.A Aquarium&amp;trade;") {
                            $desc_length = 200;
                        } else {
                            $desc_length = 115;
                        }
                            ...
                            <div class="tour_container">
                                <div class="img_container">
                                    ...
                                    <a id="i_<?php echo $wid; ?>" onclick="return setcart(this.id)" style="cursor:pointer" >
                                        <img src="<?php echo $image_path; ?>" class="img-responsive product-img" alt="" id="prod-img<?php echo $wid;?>">
                                        <img src="<?php echo $image_path; ?>" class="img-responsive product-img blur" alt="" style="display: none;" id="progress<?php echo $wid;?>">
                                        <div class="ribbon <?php echo $Product_feature; ?>" id="ribbon<?php echo $wid;?>"></div>
                                        <div class="short_info" id="short_info<?php echo $wid;?>">
...
<!--                                    <div class="wishlist">
                                    ...
                                    <div style="text-align:center">
                                        <a class="btn_1 green"  data-toggle="modal" data-target="#myModal<?php echo $wid; ?>" style="min-width:115px !important; padding:7px 10px;">Read more</a>
  ...
  <button id="close_modal" class="btn btn-default" type="button" data-dismiss="modal" aria-label="Close" style="float: right;font-size: 14px;padding: 10px;">Close</button>                                      
...
<?php } ?>
        ...
        <div class="white_bg">
            <div class="col-md-12 margin_60 " style="float:none">
                    ...
                    foreach ($product_data1 as $popular_feature) {
                        ...
                        ?>
                            <div class="col-md-4 other_tours">
                                <ul>
                                <!---<a href="<?= site_url('kiosk/single_tour.php'); ?>?id=<?php echo $pf_id; ?>">--->
                ...
                <?php } ?>
                <?php
//                $query = "SELECT * FROM product where is_deleted='N' and is_active='Y' and is_feature='Y' and adult_price>'0.00' ORDER BY RAND() LIMIT 1";
...
<!--                        <div class="banner colored">
                            ...
                            <a href="<?= site_url('kiosk/single_tour.php') ?>?id=<?php echo $rows['id']; ?>" class="btn_1 white">Read more</a>
                        </div>-->
                            <?php // }
//                        } ?>
...
//                                    $image_path2 = '../img/products/product_94.jpg';
                                ?>
                                        <p>
                                            <a href="<?= site_url('kiosk/categorywise_tours_list.php'); ?>?id=<?php echo $category['id']; ?>"><img src="<?php echo $image_path2; ?>" alt="Pic" class="img-responsive cat_img"></a>
                                        </p>
            <?php // }
//        } ?>
...
?>
                        ...
                        <a href="<?= site_url('kiosk/about.php') ?>" class="btn_1 outline">Read more</a>
                    </div>
                </div>
