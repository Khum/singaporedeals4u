                ...
                <div class="col-md-12">
                    <div id="social_footer">
                        <ul>
                            ...
                            <li><a href="<?=site_url('kiosk/');?>"><i class="icon-twitter"></i></a></li>
                            <li><a href="<?=site_url('kiosk/');?>"><i class="icon-google"></i></a></li>
                            <li><a href="<?=site_url('kiosk/');?>"><i class="icon-instagram"></i></a></li>
                            <li><a href="<?=site_url('kiosk/');?>"><i class="icon-pinterest"></i></a></li>
