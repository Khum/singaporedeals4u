	...
	<div class="row">
		<div class="col-md-8">
			...
			<div class="form_title">
				<h3><strong><i class="icon-ok"></i></strong>404 Error</h3>
				<p>
			...
			<div class="step">
				<h5>
					Sorry your registration is not completed due to some error
				</h5>
				<p>Try to copy paste that link in to the browser.</p>
				<p>Good Luck!</p>
