...
<li>
<a href="http://themeforest.net/item/citytours-city-tours-tour-tickets-and-guides/10715647?ref=ansonika">Purchase this template</a>
</li>
                        </ul>
                    </div>
                </div><!-- End row -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">                    
                    <div id="logo">
                        <a href="index.html"><img src="img/logo.png" width="270" height="75" alt="Stability" data-retina="true" class="logo_normal"></a>
                        <a href="index.html"><img src="img/logo_sticky.png" width="270" height="75" alt="Stability" data-retina="true" class="logo_sticky"></a>
                    </div>
                </div>
                    ...
                    <div class="main-menu">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                             ...
                             <li class="submenu">
                                <a href="javascript:void(0);" class="show-submenu">About Us <i class="icon-down-open-mini"></i></a>                              	<ul>
                                    <li><a href="about.html">About us</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);" class="show-submenu">Contacts <i class="icon-down-open-mini"></i></a>								 <ul>
...
<div class="margin_60 container">
	<div id="tour_guide">
		<p>
			<img src="img/tourist_guide_pic.jpg" alt="" class="img-circle styled">
		</p>
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<p>
				<img src="img/lang_en.png" width="40" height="26" alt="" data-retina="true"><img src="img/lang_fr.png" width="40" height="26" alt="" data-retina="true">
				<img src="img/lang_de.png" width="40" height="26" alt="" data-retina="true"><img src="img/lang_es.png" width="40" height="26" alt="" data-retina="true">
			</p>
