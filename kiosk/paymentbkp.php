				...
				<div class="row">
	                                <div class="col-md-6 col-sm-6">
	                                    <div class="form-group">
	                                        ...
	                                        <input type="text" class="form-control" id="hotel_name" name="hotel_name" value="Fragrance Hotel" disabled>
	                                ...
	                                <div class="col-md-6 col-sm-6">
	                                    <div class="form-group">
                                        	...
                                        	<input type="text" class="form-control" id="hotel_add" name="hotel_add" value="Riverside at 20 hongkong street" disabled>
                                        	
                                        	<input type="hidden" class="form-control" id="hotel_a" name="hotel_a" value="Riverside at 20 hongkong street">
                                    	</div>
                                </div>
...
<!--					<label><input type="radio" name="payment" id="payment" value="paypal">Paypal</label>-->
                            ...
                            <div class="form-group" id="delivery_types">
                                        ...
                                        <label><input type="radio" class="option" id="express" name="delivery"  value="express" checked>Express Delivery (Within 30 Minutes - Additional SGD 10.00)</label>
                                        <label><input type="radio"  name="delivery" id="free_del" value="free" >Free Delivery</label>
                            </div>
                            <div class="form-group" id="time_slots">

                                        <label><input type="radio" class="option" name="time_slots" id="time_slots" value=8" checked>8:30am to 9:00am</label>
                                        <label><input type="radio" class="option" name="time_slots"  value="12" > 12:00 pm to 12:30 pm</label>
                                        <label><input type="radio" class="option" name="time_slots" id="delivery" value="6" >6:00pm to 6:30pm</label>
                                        <label><input type="radio" class="option" name="time_slots"  value="11" >11:30pm to 12:00am</label>
                            </div>
