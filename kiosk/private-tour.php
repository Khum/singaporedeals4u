                ...
                <div class="step">
                    ...
                    <form action="private-tour-process.php" method="post">
                        ...
                        <div class="row">
                            <div class="f-item">
                                ...
                                <input  class="date-pick form-control" data-date-format="M d, D" type="text" name="in_dates" required>
                        ...
                        <div class="row">
                            <div class="f-item">
                                <label for="your_name"><i class="icon-calendar-7"></i> Travelling Date <span class="required">*</span></label>            
                                <input  class="date-pick form-control" data-date-format="M d, D" type="text" name="tr_dates" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="f-item">
                                <label for="your_name"><i class="icon-calendar-7"></i> Arrival Date <span class="required">*</span></label>            
                                <input  class="date-pick form-control" data-date-format="M d, D" type="text" name="arrival-date" required>
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="f-item">
                                <label for="arrival-option"> Arrival Option</label>            
                    ...
                    <div class="row">
                         <div class="col-md-3 col-sm-6">
                            ...
                            <div class="numbers-row">
                                <input type="text" value="1" id="adults" class="qty2 form-control" name="number-of-night" disabled="disabled">
                             </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="numbers-row">
                                    <input type="text" value="1" id="adults" class="qty2 form-control" name="adults" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="numbers-row">
                                    <input type="text" value="0" id="children" class="qty2 form-control" name="child" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="numbers-row">
                                    <input type="text" value="0" id="children" class="qty2 form-control" name="infant" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            ...
                            <label for="your_name"><i class="icon_set_1_icon-81"></i> Hotel Preference </label>
                                <div class="numbers-row">
                                    <input type="text" value="4" id="adults" class="qty2 form-control" name="hotel-start-preference" max="5" disabled="disabled">
                                </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3">
                            ...
                            <div class="form-group">
                               <label >From</label>                                
                               <input type="text" placeholder="0000.00" id="budget" name="budget-from" class="form-control fcpt">
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3">                            
                           <div class="form-group">
                               <label>To</label>                                
                               <input type="text" placeholder="0000.00" id="budget" name="budget-to" class="form-control fcpt">
                            </div>                        
                        </div>
