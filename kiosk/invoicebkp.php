...
<header id="plain"><?php include_once 'header.php'; ?></header><!-- End Header -->    
    ...
    if(($_POST['payment'] == 'ticket') && !empty($_SESSION[$_SESSION['Auth_name']]))
        {
            ...
            if($_POST['delivery'] == 'express')
            {
                ...
                {
                    $Del_time = "6:00am to 6:30am";
                }
                else{
                     $Del_time = "11:30am to 12:00am";
                }
            }
  ...
  <div class="container" id="ticket_div" style="margin-top:130px;display:none">
    <div class="row">
		...
		<div class="row">
    			<div class="col-xs-6">
                                <strong>Hotel Name: </strong><?php echo ' '.$hname; ?></div>
                        <div class="col-xs-6">
                                <strong>Hotel Address: </strong><?php echo ' '.$hadd; ?></div>
               </div>
    		<div class="row">
    			<div class="col-xs-6">
                                <strong>Room No: </strong><?php echo ' '.$_POST['room_no']; ?></div>
                      ...
                      <tbody>
                            ...
                            if($_POST['delivery'] == 'express')
                            {
                                ...
                                <tr class="filters" style="font-size:16px">
                                            ...
                                            <td style="font-weight:bold"><strong>Express Develiery</strong></td>
                                            <td>SGD 10</td>
                                        </tr>
                              <?php   
                            ...
                            else
                            {
                               ?>
                                <tr class="filters" style="font-size:16px">
                                            ...
                                            <td style="font-weight:bold"><strong>Free Develiery</strong></td>
                                            <td>Free</td>
                                        </tr>
                                <?php 
                                $email_content .='<tr class="filters" style="font-size:16px">
                            ...
                            ?>
                                <tr class="filters" style="font-size:16px">
                                    ...
                                    <td style="font-weight:bold"><strong>Develiery Time</strong></td>
    ...
    <?php
        echo '<br><br><div class=" panel-heading" style="margin-top:120px;text-align:center" >
                <p style="font-size:24px !important">Your Order is Confirmed & the Reference Number is '.$First_order_id.'</p>
                <p style="font-size:20px !important">We will deliver tickets at '.$Del_time.'</p>
                <p style="font-size:20px !important">Please prepare Total Amount SGD '.$grand_total.' <Total Amount> and wait in Hotel Lobby</p>
