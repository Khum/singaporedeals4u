...
<header >
    ...
    <?php
        ...
        if($_POST['payment'] == 'spot' && !empty($_SESSION[$_SESSION['Auth_name']]) )
        {
	     ...
	     $hname = $_POST['hotel_name'];
            ...
            $room = $_POST['room_no'];
            if( $_POST['delivery_opt'] == 'at airport')
            {
               $flight_no = $_POST['flight_no'];
               $arriving_from = $_POST['arriving_from'];
               $flight_datetime = $_POST['arrival_date'].' '.date('H:i:s',strtotime($_POST['arrival_time']));  
            }
            else
            {
               $flight_no = '';
  ...
  <div class="container" style="margin-top:130px;">
                ...
                if( $_POST['delivery_opt'] == 'at airport')
                {
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <?php echo $arriving_from; ?>
                        </div>
                        <div class="col-xs-6">
                            <strong> Flight Time: </strong>
                            <?php echo $flight_datetime; ?>
                        </div>
                    </div>    
                    <?php 
    ...
    <div class="row">
    		...
    		<div class="panel panel-primary filterable">
    			...
    			<div class="panel-body">
                    ...
                    $order_ins ="INSERT INTO `order`(`full_name`, `email`, `mobile`, `hotel_name`, `hotel_address`,`room_no`, `total_adult`, `total_child`, `tour_date`, "
                                        ...
                                        . "`welcome`, `dinner`, `bike`, `two_way`, `delivery_type`,`delivery_date`, `flight_no`,`arriving_from`, `arrival_datetime` , `is_deleted` ) values"
                              . "('".$name."','".$email."','".$phone."','".$hname."','".$hadd."','".$room."','".$item['a_qty']."','".$item['c_qty']."','".$date."', '".$time
                                        ...
                                        ."','".$guide."','".$pickup."','".$insurance."','".$coffee."','".$welcome."','".$dinner."','".$bike."','".$two_way."',"
                                        . "'".$_POST['delivery_opt']."', '".$delivery_date."', '".$flight_no."', '".$arriving_from."','".$flight_datetime."','N' )";
                        ...
                        ?>        
                            ...
                            <?php 
                                ...
                                $email_content .= "
                                    <tr>
                                        <td> Delivery type </td>
                                        <td>". $_POST['delivery_opt'] ." </td>
                                    </tr>
                                    <tr>
                                        <td> Delivery Date </td>
                                        <td>". $_POST['del_date'] ." </td>
                                    </tr>
                                    ";
                                $email_content .= "
                                    <tr>
                            ...
                            ?>                          
                                        <hr> 
                                            <tr class="filters">
                                                <td style="font-weight:bold"><strong>Delivery type</strong></td>
                                                <td><?php echo $_POST['delivery_opt']; ?></td>
                                            </tr>
                                            <tr class="filters">
                                                <td style="font-weight:bold"><strong>Delivery Date</strong></td>
                                                <td><?php echo $_POST['del_date']; ?></td>
                                            </tr>
       ...
       <!--     <a class=" btn_full" href="index.php"><i class="icon-right"></i> Continue Shopping</a>---->
    	</div>
    </div>
</div>
    	...
    	<?php 
        	  unset($_SESSION[$_SESSION['Auth_name']]);
                ...
                else if($_POST['payment'] == 'paypal' && (!empty($_SESSION[$_SESSION['Auth_name']])))
                {
               		...
               		$name = $_POST['firstname_booking'].' '.$_POST['lastname_booking'];
			$_SESSION['name_pp'] = $name;
			//// Sessions for paypal email order confirmation 
			$email = $_POST['email_booking'];
			$_SESSION['email_pp'] = $email;
			
			$phone = $_POST['telephone_booking'];
			$_SESSION['phone_pp'] = $phone;
			
			$hname = $_POST['hotel_name'];
			$_SESSION['hname_pp'] = $hname;
			
			$hadd = $_POST['hotel_add'];
			$_SESSION['hadd_pp'] = $hadd;
			
			$room = $_POST['room_no'];
			$_SESSION['room_pp'] = $room;
...
//                                        ."('".$name."','".$email."','".$phone."','".$hname."','".$hadd."','".$room."','".$item['a_qty']."','".$item['c_qty']."','".$date."', '".$time
//                                        ."','".$item['pid']."','".$item['name']."','".$item['adult_price']."','".$item['child_price']
//                                        ."','".$Total_aprice."','".$Total_cprice."','".$product_total."','"."paypal','new','".$date_added 
//                                        ."','".$guide."','".$pickup."','".$insurance."','".$coffee."','".$welcome."','".$dinner."','".$bike."','".$two_way."','N')";
        ...
        ?>
            <form action="https://<?php echo $domain; ?>/cgi-bin/webscr" method="post" id="paypal_frm" name="paypal_frm"/>
                ...
                <input type="hidden" name="item_name_1" value="Singaporedeals Booking"/>
	    ...
	    if(!empty($email_content)){
	    	$send = mail($to,$subject,$customer.$email_content,$headers);
