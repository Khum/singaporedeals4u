<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    ...
                    <h3>Need help?</h3>
                    <a href="tel://0065-90886618" id="phone">+65 8161 5060</a>
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=site_url('wishlist.php');?>">Wishlist</a></li>
                         ...
                         <li><a href="<?=site_url('disclaimer.php');?>">Disclaimer</a></li>
                    </ul>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#customer_signin").click(function(){
